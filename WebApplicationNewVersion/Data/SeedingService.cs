...
namespace WebApplicationNewVersion.Data
{
    ...
    {
        private WebApplicationNewVersionContext _context;

        public SeedingService(WebApplicationNewVersionContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1998, 3, 8), 3000.0, d1);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1996, 12, 21), 3000.0, d2);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1995, 4, 30), 1000.0, d2);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 9, 19), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "pink@gmail.com", new DateTime(1991, 4, 24), 3000.0, d4);
